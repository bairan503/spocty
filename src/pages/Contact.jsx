...
import { MapPin, Phone, Mail, Clock, Send, MessageSquare, User, Building, MessageCircle, Heart } from 'lucide-react'
...
const Contact = ({ onNavigate }) => {
  ...
  const cooperation = [
    { icon: Heart, title: '社区合作', desc: '老旧小区改造居委会社区街道办' },
    { icon: Building, title: '企业公益', desc: '公益基金会爱心企业社会责任部门' },
    { icon: MessageSquare, title: '政府对接', desc: '住建局民政局城市更新相关部门' },
  ]
    ...
    <div className="pt-16">
      <section className="relative min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-50"
          style={{ backgroundImage: `url('/images/contactheader.jpg')` }}>
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">联系我们</h1>
            <p className="text-xl text-white/90">携手共建韧性社区，让每一滴雨水成为生命之源</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6">
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-meta-blue/10 rounded-lg flex items-center justify-center flex-shrink-0">
                      <item.icon className="w-6 h-6 text-meta-blue" />
                    </div>
                    <div>
              ...
              <div className="mt-8">
                <h3 className="font-semibold text-gray-900 mb-4">合作洽谈</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="请输入您想咨询的内容，如：社区基本情况、改造意向、合作方式等..."
                  ></textarea>
                </div>
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-500 text-white py-4 rounded-lg font-semibold hover:from-green-700 hover:to-emerald-600 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="bg-white rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-green-50 rounded-xl">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">在线咨询</h4>
                <p className="text-gray-500 text-sm mb-4">添加微信了解更多</p>
              ...
              <div className="text-center p-6 bg-blue-50 rounded-xl">
                ...
                <p className="text-gray-500 text-sm mb-4">+86 29 8888 6666</p>
              ...
              <div className="text-center p-6 bg-yellow-50 rounded-xl">
                ...
                <p className="text-gray-500 text-sm mb-4">contact@qianmohaimian.org</p>
